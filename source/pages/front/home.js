...
export default async function main(){
	return `
		<container class="page_home padding-5 gap-1 max-width-1200px">
			<column class="surface-v1 padding-5 gap-1">
				<p class="text-size-2rem">Welcome to x!</p>
				...
				<p class="text-color-secondary text-size-0-9rem">You're on the "/home" page.</p>
			</column>
		</container>
	`;
}
