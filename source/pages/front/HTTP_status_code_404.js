	...
	return `
		<container class="justify-content-center align-items-center padding-5 bg-error font-family-Poppins">
			<section class="display-grid place-items-center">
				<p class="grid-area-1-slash-1 text-size-15rem text-color-hsla-0-0-100-0-3">404</p>
				<p class="grid-area-1-slash-1 text-size-3rem text-color-white">${window.Lang.use("not_found")}</p>
			</section>
