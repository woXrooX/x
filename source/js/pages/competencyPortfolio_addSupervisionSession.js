...
export const TITLE = window.Lang.use("competencyPortfolio_addSupervisionSession");
...
<container class="py-5">
  <row>
    <column class="w-70 p-5 surface-clean">
      ...
      <h1>${window.Lang.use("supervision_session")}</h1>

      <form action="/competencyPortfolio/addSupervisionSession" for="addSupervisionSession">

        <label>
          <p for='title'>Title of supervision session</p>
        ...
        <label>
          <p for='supervisorFullName'>Supervisor full name</p>
          <input type='text' name='supervisorFullName'>
        </label>

        <label>
          <p for='workplaceEmployer'>Supervisor Workplace/Employer</p>
          <input type='text' name='workplaceEmployer'>
        </label>

        <label>
          <p for='jobRole'>Supervisor job role</p>
          <input type='text' name='jobRole'>
        </label>

        <label>
          <p for='eMail'>Supervisor email</p>
          <input type='eMail' name='eMail'>
        </label>

        <label>
          <p for='telephone'>Supervisor telephone number</p>
          <input type='tel' name='telephone'>
        </label>

        <label>
          <p for='GMC_GPhC_NMC_number'>Supervisor GMC/GPhC/NMC number</p>
        ...
        <label>
          <input class="btn btn-primary" type='submit' name='addSupervisionSession' value='Save'>
          <p for='addSupervisionSession'></p>
        </label>
