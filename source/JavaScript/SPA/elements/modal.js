export default class Modal extends HTMLElement{
	...
	static #shown = false;
	static #locked = false;
	static #prevent_unload = (event) => event.preventDefault();;
	static #FUNC_POOL = {};
	...
	static lock(){
		...
		// Prevent reload
		window.addEventListener("beforeunload", Modal.#prevent_unload);
	}
	...
	static unlock(){
		...
		window.removeEventListener("beforeunload", Modal.#prevent_unload);
	}
